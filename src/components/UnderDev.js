	...
	return (
		<div className="underDev-container">
			<div className="underDev">
				...
				<p>Click on the board to start. Then use your keyboard arrow keys to control the snake towards each highlighted food square without biting your own tail.<br /> Good Luck and have fun!</p>
